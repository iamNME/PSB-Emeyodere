        ...
        <div class="col-md-12">
          <div class="card card-outline card-info">
            <!-- <div class="card-header pr-4 pl-4">
              ...
              <form class="form-horizontal" action="update-album-video.php" method="post" enctype="multipart/form-data">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <img width="50%" height="250" src="albumvideo/<?= $foto ?>" id="preview" alt="Foto" style="object-fit: cover;">
                    </div>
                  </div>

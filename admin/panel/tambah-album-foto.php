            ...
            <!-- <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
                  ...
                  if($size < 2048000 && in_array($ext, $ekstensi)){
                    ...
                    $sql = "INSERT INTO albumfoto (id_albumf, namaalbum, sampul_foto) VALUES ('$id', '$namaAlbum', '$fotoname')";
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="namaalbum" class="form-control" id="namaalbum" placeholder="Nama Album Foto" required min="0" max="100">
                    </div>
                  </div>
                  <div class="form-group row">

        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="view-album-video.php">Data Album Video</a></li>
            ...
            <!-- <div class="card-header pr-4 pl-4">
              ...
              <!-- form start -->
                  ...
                  if($size < 2048000 && in_array($ext, $ekstensi)){
                    ...
                    $sql = "INSERT INTO albumvideo (id_albumv, namaalbum, sampul_foto) VALUES ('$id', '$namaAlbum', '$fotoname')";
              ...
              ?>
                      <div class="container pl-4 pr-3 pt-4">
                        <div class="alert alert-success alert-dismissible">
                            ...
                            <b>Album Berhasil</b> ditambahkan ke dalam database
                        </div>
                      </div>
              <?php
                    }else{
              ?>
                      <div class="container pl-4 pr-3 pt-4">
                        <div class="alert alert-danger alert-dismissible">
                            <b>Album Tidak Berhasil</b> ditambahkan ke dalam database
                        </div>
                      </div>
              <?php
                    }
              ...
              <form class="form-horizontal" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" enctype="multipart/form-data">
                <div class="card-body pr-4 pl-4">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <input type="text" name="namaalbum" class="form-control" id="namaalbum" placeholder="Nama Album Video" required min="0" max="100">
                    </div>
                  </div>
                  <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                      <img width="50%" height="250" src="" class="hidden" id="preview" alt="Foto" style="object-fit: cover;">
                    </div>
                  </div>

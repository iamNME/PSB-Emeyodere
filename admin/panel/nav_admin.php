<div class="wrapper">
        ...
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item dropdown user user-menu">
            <a class="nav-link" data-toggle="dropdown" href="#">
              ...
              <!-- <img src="http://localhost/webgudang/assets/upload/user/img/nopic2.png" class="user-image" alt="User Image" style="float: left; vertical-align: middle; width: 30px; height: 30px; border-radius: 50%; margin-top: -2px;"> -->
      ...
      <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <!-- Brand Logo -->
        <!-- kasih background untuk pewarnaan -->
        <a href="index.php" class="brand-link" style="/*background: #22DDe1*/">

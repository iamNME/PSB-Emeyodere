        ...
        <div class="container" style="padding-top: 5rem; padding-bottom: 20rem;">
            ...
            <div class="row mt-4 mb-3">
                ...
                <div class="col-sm-4 mb-3">
                    <div class="card">
                        <a href="album_foto.php?id=<?= $row['id_albumf'] ?>" class="text-dark" style="text-decoration: none">
                            <img src="admin/panel/albumfoto/<?= $row['sampul_foto'] ?>" alt="Picture" class="card-img-top">
                            <div class="card-body">
